...
// productRoutes.get('/product/list/:id', (req, res) => {
//   let productdata = getProductData()
//   // const sData = data.id
//   fs.readFileSync(productDataPath, 'utf8', (err, data) => {
//     const productId = req.params['id'];
//     console.log(productId);
//     productdata[productId] = req.body
//     res.send(productId)
//   })
//   // return JSON.parse(singleData)
//   // res.send(product)
